...
export function AppHeader({ search }: { search: SearchData }) {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 shrink-0 items-center gap-2 rounded-t-xl border-b bg-background/85 px-3 backdrop-blur-sm print:hidden sm:px-4">
